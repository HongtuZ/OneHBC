...
All the environments are registered in the `OneHBC` extension. They start
...
def main():
    """Print all environments registered in `OneHBC` extension."""
    ...
    for task_spec in gym.registry.values():
        if "OneHBC-" in task_spec.id and (args_cli.keyword is None or args_cli.keyword in task_spec.id):
